...
const HEARTH: Ring = {
  ...
  props: [
    ...
    { t: "hearth", x: 0, y: -70, id: "hearth", label: "CIRQLSPACE" },
    ...
    // a flower bed east of the cottage (fences now live in décor / stores, not levels)
    { t: "flower", x: 185, y: -55, accent: "#ffd24a" }, { t: "flower", x: 200, y: -48, accent: "#ff8fbf" },
    { t: "flower", x: 175, y: -44, accent: "#e0a0ff" }, { t: "flower", x: 196, y: -60, accent: "#ffffff" },
