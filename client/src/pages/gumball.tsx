...
export default function Gumball() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center" style={{ background: "#160a18", color: "#ffe6f5", touchAction: "none", userSelect: "none" }}>
      <div className="flex w-full max-w-[560px] items-center gap-3 px-4 pb-1 pt-3">
        ...
        <div className="ml-1 text-sm font-extrabold uppercase tracking-wide" style={{ color: "#ff8ab5", textShadow: "0 0 10px rgba(255,138,181,.5)" }}>Gumball</div>
      </div>

      <div className="relative flex min-h-0 w-full flex-1 items-center justify-center p-2">
        <canvas ref={canvasRef} data-testid="gumball-canvas" className="block" style={{ imageRendering: "pixelated", boxShadow: "0 0 60px rgba(255,138,181,.18)", borderRadius: 6 }} />
        {over && daily && (
      ...
      <div className="flex w-full max-w-[560px] items-center justify-between gap-4 px-8 pb-[calc(18px+env(safe-area-inset-bottom))] pt-2">
        <button {...hold("left")} data-testid="btn-left" className="flex h-20 w-24 items-center justify-center rounded-2xl border-[2px] active:scale-95" style={{ borderColor: "#ff8ab5", background: "rgba(255,255,255,.03)", boxShadow: "0 0 20px rgba(255,138,181,.22) inset", touchAction: "none" }}><ChevronLeft className="h-9 w-9 text-pink-200" /></button>
        <button {...hold("right")} data-testid="btn-right" className="flex h-20 w-24 items-center justify-center rounded-2xl border-[2px] active:scale-95" style={{ borderColor: "#ff8ab5", background: "rgba(255,255,255,.03)", boxShadow: "0 0 20px rgba(255,138,181,.22) inset", touchAction: "none" }}><ChevronRight className="h-9 w-9 text-pink-200" /></button>
      </div>
    </div>
  );
}
