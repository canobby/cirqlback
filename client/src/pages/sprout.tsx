...
export default function Sprout() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center" style={{ background: "#1a1206", color: "#ffe6c2", touchAction: "none", userSelect: "none" }}>
      <div className="flex w-full max-w-[560px] items-center gap-3 px-4 pb-1 pt-3">
        ...
        <div className="ml-1 text-sm font-extrabold uppercase tracking-wide" style={{ color: "#33e650", textShadow: "0 0 10px rgba(51,230,80,.5)" }}>Sprout</div>
        <div className="ml-auto text-[10px] uppercase tracking-wide text-emerald-300/60">Tap the gophers</div>
      </div>

      <div className="relative flex min-h-0 w-full flex-1 items-center justify-center p-2">
        <canvas ref={canvasRef} data-testid="sprout-canvas" className="block" style={{ imageRendering: "pixelated", boxShadow: "0 0 60px rgba(51,230,80,.16)", borderRadius: 6, cursor: "pointer" }} />
        {over && daily && (
      ...
      <div className="pb-[calc(18px+env(safe-area-inset-bottom))]" />
    </div>
  );
}
