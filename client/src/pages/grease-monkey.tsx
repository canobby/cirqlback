...
export default function GreaseMonkey() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center" style={{ background: "#0a1420", color: "#e6e9ff", touchAction: "none", userSelect: "none" }}>
      <div className="flex w-full max-w-[560px] items-center gap-3 px-4 pb-1 pt-3">
        ...
        <div className="ml-1 text-sm font-extrabold uppercase tracking-wide" style={{ color: "#ffd24a", textShadow: "0 0 10px rgba(255,210,74,.5)" }}>Grease Monkey</div>
      </div>

      <div className="relative flex min-h-0 w-full flex-1 items-center justify-center p-2">
        <canvas ref={canvasRef} data-testid="grease-canvas" className="block" style={{ imageRendering: "pixelated", boxShadow: "0 0 60px rgba(255,210,74,.16)", borderRadius: 6 }} />
        {over && daily && (
      ...
      <div className="flex w-full max-w-[560px] items-center justify-between gap-4 px-8 pb-[calc(18px+env(safe-area-inset-bottom))] pt-2">
        <button {...hold("left")} data-testid="btn-left" className="flex h-20 w-24 items-center justify-center rounded-2xl border-[2px] active:scale-95" style={{ borderColor: "#ffd24a", background: "rgba(255,255,255,.03)", boxShadow: "0 0 20px rgba(255,210,74,.22) inset", touchAction: "none" }}><ChevronLeft className="h-9 w-9 text-amber-200" /></button>
        <button {...hold("right")} data-testid="btn-right" className="flex h-20 w-24 items-center justify-center rounded-2xl border-[2px] active:scale-95" style={{ borderColor: "#ffd24a", background: "rgba(255,255,255,.03)", boxShadow: "0 0 20px rgba(255,210,74,.22) inset", touchAction: "none" }}><ChevronRight className="h-9 w-9 text-amber-200" /></button>
      </div>
    </div>
  );
}
