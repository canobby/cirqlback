...
export default function ChopShop() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center" style={{ background: "#160c14", color: "#ffe6ea", touchAction: "none", userSelect: "none" }}>
      <div className="flex w-full max-w-[560px] items-center gap-3 px-4 pb-1 pt-3">
        ...
        <div className="ml-1 text-sm font-extrabold uppercase tracking-wide" style={{ color: "#ff5d7d", textShadow: "0 0 10px rgba(255,93,125,.5)" }}>Chop Shop</div>
      ...
      <div className="relative flex min-h-0 w-full flex-1 items-center justify-center p-2">
        <canvas ref={canvasRef} data-testid="chopshop-canvas" className="block" style={{ imageRendering: "pixelated", boxShadow: "0 0 60px rgba(255,93,125,.18)", borderRadius: 6, touchAction: "none" }} />
        {over && daily && (
      ...
      <div className="w-full max-w-[560px] px-6 pb-[calc(20px+env(safe-area-inset-bottom))] pt-2 text-center text-[12px] font-bold uppercase tracking-[0.1em]" style={{ color: "#ff8ab5" }}>
        ✦ Swipe across the screen to slice ✦
      </div>
    </div>
  );
}
