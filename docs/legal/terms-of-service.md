...
These Terms of Service ("**Terms**") are a legal agreement between you and **[COMPANY LEGAL NAME]**, a [STATE OF FORMATION] [ENTITY TYPE] ("**Cirqlback**," "**we**," "**us**"), governing your access to and use of the Cirqlback websites, apps, tap-to-earn features, and related services (collectively, the "**Service**"). By creating an account, tapping a Cirqlback tag, or otherwise using the Service, you agree to these Terms and to our [Privacy Policy](privacy-policy.md). If you do not agree, do not use the Service.

Business customers and Community Coordinators are also subject to additional agreements (the [Merchant Agreement](merchant-agreement.md) and the [Coordinator Independent Contractor Agreement](coordinator-independent-contractor-agreement.md), respectively). If those conflict with these Terms, the specific agreement controls for that relationship.
